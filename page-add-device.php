...
<section class="layout my-5 sm:my-10">
  <div class="flex flex-col justify-center  items-center gap-3">
    ...
    <a href="<?php echo site_url() . '/add-experiment'?>" class="text-lg sm:text-xl text-primary font-bold">إضافة
      تجربة</a>
  </div>
  <form method="POST" class="experimentForm mt-5 sm:mt-8" enctype="multipart/form-data">
